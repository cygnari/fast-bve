...
int main(int argc, char** argv) {
    ...
    BaryTreeInterface(run_information.particle_own, run_information.particle_own,
        ...
        &c_x[0], USER, 1, kernel_params, SKIPPING, LAGRANGE, PARTICLE_PARTICLE, run_information.fast_sum_theta, run_information.interp_degree,
        500, 500, 1.0, -1, -1);

    BaryTreeInterface(run_information.particle_own, run_information.particle_own,
        &typoints[0], &tzpoints[0], &txpoints[0], &ones[0],
        &sypoints[0], &szpoints[0], &sxpoints[0], &vors[0], &own_areas[0],
        &c_y[0], USER, 1, kernel_params, SKIPPING, LAGRANGE, PARTICLE_PARTICLE, run_information.fast_sum_theta, run_information.interp_degree,
        500, 500, 1.0, -1, -1);

    BaryTreeInterface(run_information.particle_own, run_information.particle_own,
        &tzpoints[0], &txpoints[0], &typoints[0], &ones[0],
        &szpoints[0], &sxpoints[0], &sypoints[0], &vors[0], &own_areas[0],
        &c_z[0], USER, 1, kernel_params, SKIPPING, LAGRANGE, PARTICLE_PARTICLE, run_information.fast_sum_theta, run_information.interp_degree,
        500, 500, 1.0, -1, -1);
