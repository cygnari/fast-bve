...
void amr(
  ...
  new_dynamics_state = slice(old_dynamics_state, 0, 1,
      run_information.info_per_point * run_information.dynamics_initial_points);
    ...
    for (int j = 0; j < 20 * pow(4, i); j++) {
      if (new_dynamics_triangles_is_leaf[i][j]) {
        ...
        if ((tri_area * vor > run_information.amr_circ_thresh) or
          ...
          iv12 = check_point_exist2(new_dynamics_state, v12,
                                 run_information.dynamics_curr_point_count,
                                 pow(10, -14), run_information.info_per_point);
          iv23 = check_point_exist2(new_dynamics_state, v23,
                                 run_information.dynamics_curr_point_count,
                                 pow(10, -14), run_information.info_per_point);
          iv31 = check_point_exist2(new_dynamics_state, v31,
                                 run_information.dynamics_curr_point_count,
                                 pow(10, -14), run_information.info_per_point);
          ...
          if (iv23 == -1) {
            iv23 = check_point_exist2(old_dynamics_state, v23, old_point_count,
                                      ...
                                      run_information.info_per_point);
            if (iv23 == -1) {
              std::tie(tri_level, tri_index) = find_leaf_tri(v23,
                old_dynamics_state, old_dynamics_triangles,
                old_dynamics_triangles_is_leaf, run_information.info_per_point,
                                run_information.dynamics_levels_max);
              super_tri_index = floor(tri_index / 4.0);
              iv1n = old_dynamics_triangles[tri_level - 1][super_tri_index][0];
              iv2n = old_dynamics_triangles[tri_level - 1][super_tri_index][1];
              ...
              v23 = slice(old_dynamics_state, run_information.info_per_point * iv23,
                          1, run_information.info_per_point);
            }
          ...
          if (iv31 == -1) {
            ...
            if (iv31 == -1) {
              ...
              v31 = slice(old_dynamics_state, run_information.info_per_point * iv31,
                          1, run_information.info_per_point);
            }
          ...
          new_dynamics_triangles[i + 1][4 * j].insert(
              new_dynamics_triangles[i + 1][4 * j].begin(), {iv1, iv12, iv31, i + 1});
          new_dynamics_triangles[i + 1][4 * j + 1].insert(
              new_dynamics_triangles[i + 1][4 * j + 1].begin(), {iv2, iv23, iv12, i + 1});
          new_dynamics_triangles[i + 1][4 * j + 2].insert(
              new_dynamics_triangles[i + 1][4 * j + 2].begin(), {iv3, iv31, iv23, i + 1});
          new_dynamics_triangles[i + 1][4 * j + 3].insert(
              new_dynamics_triangles[i + 1][4 * j + 3].begin(), {iv12, iv23, iv31, i + 1});
