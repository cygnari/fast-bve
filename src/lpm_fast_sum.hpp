...
void point_assign(const double x, const double y, const double z,
...
void tree_traverse(const std::vector<std::vector<std::vector<int>>>
    ...
    MPI_Datatype dt_interaction, const int mpi_P, const int mpi_ID, const double radius, const double theta, const int cluster_thresh,
